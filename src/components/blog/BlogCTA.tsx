...
export function BlogCTA({
  ...
  return (
    <div className="not-prose my-12 rounded-2xl bg-amber-500 p-8 sm:p-10 text-center">
      <h3 className="text-xl sm:text-2xl font-extrabold text-white mb-3">{heading}</h3>
      <p className="text-white/90 text-sm sm:text-base mb-6 max-w-xl mx-auto leading-relaxed">{description}</p>
      <Link
        href={buttonHref}
        className="inline-flex items-center justify-center gap-2 px-8 py-3.5 text-sm font-bold text-amber-900 bg-white hover:bg-amber-50 rounded-full transition-all shadow-lg hover:shadow-xl"
      >
